...
// Short position — 3 anchors: entry, stop (above entry), target (below entry).
// Mirror of long-position: red box on top (risk), green box below (reward).
export default {
  type: 'short-position',
  ...
  render(g, ctx) {
    ...
    // SL rect (red, above entry — sl is higher price ⇒ lower y)
